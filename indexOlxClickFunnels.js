...
const main =async () => {
  ...
  const [inputEmail] = await page.$x(`//*[@placeholder="you@yourawesomebusiness.com"]`);
  const [inputPassword] = await page.$x(`//*[@placeholder="your strong password"]`);

  await inputEmail.type("admin@freedombusinessmentoring.com")
  await inputPassword.type("admin@freedombusinessmentoring.com")
